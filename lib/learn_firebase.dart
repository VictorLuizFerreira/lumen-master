...
class _LearnFirebaseState extends State<LearnFirebase> {
  List<String> listStrings = <String>["Nenhum registro"];
  Uri url = Uri.https("lumenu-1b94c-default-rtdb.firebaseio.com", "/words.json");
          ...
          RefreshIndicator(
            ...
            child: ListView(
              children: [
                ...
                for (String s in listStrings) Text(
                  s,
                  textAlign: TextAlign.center,
                )
              ],
